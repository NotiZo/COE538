...
VERIFY_STOP       CMPA  #ALL_STOP                             ; Verify if the robot's state is ALL_STOP
                  ...
                  JSR   ALL_STP_ST                           ; Validate ALL_STOP state
                  JMP   DISP_EXIT                                         
...
VERIFY_RIGHT_TRN  CMPA  #RIGHT_TRN                          ; Verify if the robot's state is RIGHT_TURN
                  ...
                  JSR   RIGHT
                  JMP DISP_EXIT                               ; Validate RIGHT_TURN state                                      
...
;Movement
;***************************************************************************************************
START_ST          BRCLR   PORTAD0, %00000100, NO_FWD                                    
                  JSR     RELEASE
                  JSR     INIT_FWD                                                               
                  MOVB    #FWD, CRNT_STATE
...
NO_FWD_BUMP       BRSET   PORTAD0, $08, NO_FWD_REAR_BUMP      ; Checks if the stern bumper 
...
ALL_STP_ST        BRSET PORTAD0,$04,NO_START_BUMP      ; If FWD_BUMP
