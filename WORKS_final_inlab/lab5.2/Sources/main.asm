...
LCD_RS        EQU   $40                       ; **LCD RS-signal pin from lab 3
FWD_INT       EQU   69                        ; 3 second delay (at 23Hz)how long the robot moves forward
REV_INT       EQU   69                        ; 3 second delay (at 23Hz)how long the robot should reverse
FWD_TRN_INT   EQU   46                        ; 2 second delay (at 23Hz)how long to stop one motor and foward turn
REV_TRN_INT   EQU   46                        ; 2 second delay (at 23Hz)how long to stop one motor from backing turn
START         EQU   0
FWD           EQU   1
REV           EQU   2
ALL_STP       EQU   3
...
; Display the battery voltage **took from lab 3**
