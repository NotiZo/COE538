...
NOT_FWD   CMPA #RETRACE 
          BNE  NOT_RETRACE
          JSR  INIT_TRN_ARND
          JMP  DISP_EXIT

NOT_RETRACE  CMPA #ALL_STP
             BNE NOT_ALL_STP
             JSR ALL_STP_ST
             JMP DISP_EXIT
...
FWD_ST      BRSET PORTAD0,$04,NO_FWD_BUMP ; If FWD_BUMP then
            ...
            MOVB #RETRACE,CRNT_STATE ; set the state to REVERSE
...
INIT_RIGHT BCLR PORTA, %00000001
           BSET PORTA, %00000010
           LDAA TOF_COUNTER               
           ADDA #RIGHT_T                   
           STAA T_TURN
