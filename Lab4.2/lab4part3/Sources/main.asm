...
;************************************************************
;definitions
OneSec      EQU   23                        ; 1 second delay (at 23Hz) (23 overflows per second)
...
A1          LDAA  #'B'                      ; Display B (for 2 sec)
            ...
            ADDA  #TwoSec                   ; **by adding on the 2 sec delay from definitions
            STAA  AT_DEMO                   ; **and save it in the alarm can reference off 4.8 in lab manual
CHK_DELAY_2 LDAA  TOF_COUNTER               ; If the current time
            CMPA  AT_DEMO                   ; **equals the alarm time (4.8 in lab manual)
